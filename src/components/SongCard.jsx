...
const SongCard = ({isPlaying,activeSong,data,song,i}) => {
  ...
  return(
  <div className="flex flex-col w-[182px] p-3 bg-white/5 bg-opacity-80 backdrop-blur-sm animate-slideup rounded-lg cursor-pointer">
  <div className="relative w-full h-44 group">
    ...
    <img alt='song_imh' src={song?.images?.coverart} />
  </div>
